...
var GameView = /** @class */ (function (_super) {
    ...
    GameView.prototype.gameOver = function () {
        ...
        this.hammer.end();
        if (!GameDialog.gameOver) {
            GameDialog.gameOver = new GameOver();
        }
        GameDialog.gameOver.centerX = 0;
        GameDialog.gameOver.centerY = 40;
        GameDialog.gameOver.setScoreUI(this.score);
        Laya.stage.addChild(GameDialog.gameOver);
        console.log("游戏结束！");
    };
